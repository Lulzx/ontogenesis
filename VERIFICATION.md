...
**Date:** 2026-08-10 · **Audited HEAD:** `f1f1f87` ("disc: parallelize the C8 template pre-filter across cores")
...
5. **What is still genuinely not built:** unrestricted **schema invention** — new
   binder structures, inner-λ combinators, map-under-structure / tree-fold / etc. — and
   the World A/B/C demo (G_A ≠ G_B ≠ G_C from the same substrate). Those remain open.
